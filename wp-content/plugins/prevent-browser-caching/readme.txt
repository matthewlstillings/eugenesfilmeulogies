...
Tags: prevent, browser cache, javascript, css, js, scripts, styles, new version, frontend, development
...
Updates the version of all CSS and JS files.
...
Prevent Browser Caching provides you with options to update the version of all CSS and JavaScript files automatically.

You can also update styles and scripts for all site visitors manually in one click.
...
1. Download Prevent Browser Caching.
